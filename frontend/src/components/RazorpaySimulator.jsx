        ...
        >
          ...
          <div className="bg-[#02042b] p-4 flex items-center justify-between">
             <div className="flex items-center gap-2">
                ...
                <span className="text-white font-bold text-sm">Razorpay Checkout</span>
             </div>
          ...
          <div className="p-6 sm:p-8 flex flex-col items-center text-center">
             ...
             {stage === 'processing' ? (
                <div className="flex flex-col items-center py-6">
                    ...
                    <h3 className="text-lg font-bold text-slate-800">Processing UPI Transfer</h3>
                    <p className="text-sm text-slate-500 mt-1">Connecting to bank...</p>
                </div>
             ) : (
                <motion.div 
                ...
                >
                    ...
                    <div className="flex items-center gap-1 text-3xl font-black text-slate-900 mt-2 mb-1">
                        <IndianRupee className="w-6 h-6" /> {claim?.payoutAmount || "800"}
                    </div>
                    <p className="text-sm text-slate-500 font-medium">Credited to primary UPI account</p>
                    
                    <div className="w-full bg-slate-50 rounded-xl p-4 mt-6 border border-slate-100 text-left">
                        <div className="flex justify-between mb-2">
                            <span className="text-xs text-slate-500">From</span>
                            <span className="text-xs font-bold text-slate-800">GigShield AI Org</span>
                        </div>

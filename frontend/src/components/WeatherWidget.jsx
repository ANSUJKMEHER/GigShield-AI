...
export default function WeatherWidget({ weatherData, city }) {
  ...
  if (code >= 50 && code < 70) {
    ...
    label = "Snow";
    color = "text-white";
    bgGradient = "from-slate-400/20 to-slate-200/5";
  } else if (code >= 80) {
    Icon = CloudLightning;
    label = "Storm";
  ...
  return (
    <div
      className={`p-5 rounded-3xl border border-slate-700/50 bg-gradient-to-br ${bgGradient} backdrop-blur-xl shadow-lg relative overflow-hidden group`}
    >
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between relative z-10 w-full gap-4">
        <div>
          ...
          <div className="flex items-center gap-4 mt-2">
            ...
            <div>
              <div
                className={`text-2xl sm:text-3xl font-black ${color} tracking-tight leading-none mb-1`}
              >
